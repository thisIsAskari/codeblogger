...
<head>
    ...
    <link href="{{asset('frontend/css/libs.css')}}" rel="stylesheet"/>
...
{{--                    removed class  ftco-animate--}}
                    <div class="col-lg-4 sidebar bg-light pt-5">
                        ...
                        <div class="sidebar-box">
                            ...
                            @if($categories)
                                @foreach($categories as $category)
                                    ...
                                    <li><a href="#">{{$category->name}} <span>({{$post->where('category_id',$category->id)->count()}})</span></a></li>
